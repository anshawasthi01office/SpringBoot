    ...
    <div class="flex h-screen" style="background-color: rgb(42, 63, 84);">
        ...
        <div class="w-5/6 h-screen bg-gray-400" style="background-color: rgb(247, 247, 247);">
            ...
            <div class="w-full max-w-4xl mx-auto my-2 bg-[rgb(254,254,254)] text-gray-800 p-4 border border-gray-300">
                <h3 class="text-xl mb-4"><strong>Add Category</strong></h3>
                <hr class="mb-4 border-gray-200">
                <div class="flex flex-col gap-4">
                    <!-- First Input Field -->
                    <!-- <div class="flex items-center mb-4">
                        <label class="w-full md:w-1/4 text-left font-medium text-gray-700 required" for="id">Id</label>
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <select id="category" class="form-select flex-1 p-2 text-sm border border-gray-300">
